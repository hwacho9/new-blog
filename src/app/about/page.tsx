        ...
        <div className="max-w-2xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
                <div className="prose prose-blue max-w-none">
                    ...
                    <p>
                        This blog is a space where I share my thoughts and
                        experiences on various topics that interest me. I plan
                        to write about technology, daily life, hobbies, and
                        more.
                    </p>
